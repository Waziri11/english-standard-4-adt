# English Pupil's Book Standard Four — ADT Bundle Reference
...
**English Pupil's Book Standard Four** — This is a Tanzanian primary English textbook for Standard Four, written in English and published by the Tanzania Institute of Education. It targets upper primary learners, roughly around Grade 4, and teaches practical language skills through everyday contexts such as home, school, hospitals, markets, transport, and daily routines. The book covers vocabulary, grammar, speaking, reading comprehension, pronunciation, message writing, and simple creative writing, using short dialogues, stories, pictures, and guided activities. Its overall approach is competency-based and highly practical, aiming to build confident communication in both spoken and written English.
...
├── ENGLISH-STD-4-2024.db                    # SQLite database (pipeline state)
├── ENGLISH-STD-4-2024.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Green Certificate of Approval from the United Republic of Tanzania Ministry of Education, Science and Technology for English Pupil’s Book Standard Four, certificate No. 1622, showing the Tanzania Institute of Education as publisher and author, ISBN 978-9912-756-09-0, approval dated 11 September 2024, and the signature of Dr Lyabwene M. Mtahabwa, Commissioner for Education.",
  "gl001": "activity",
  "gl001_def": "something that a person does",
  "qz001_que": "What did Mego see in the cupboard at his grandmother’s house?",
  "qz001_o0": "1) Plates and pots",
  "qz001_o0_exp": "✅ Correct! Mego saw utensils like plates, spoons, frying pans, wooden spoons, and pots in the cupboard."
}
```
...
```json
{
  "activity": {
    ...
    "variations": ["activity","activities"],
    "emoji": "🏃📝"
  }
}
```
...
```json
{
  "title": "English Pupil's Book Standard Four",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What did Mego see in the cupboard at his grandmother’s house?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="✅ Correct! Mego saw utensils like plates, spoons, frying pans, wooden spoons, and pots in the cupboard." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Plates and pots</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `ENGLISH-STD-4-2024.pdf` |
| Pipeline database | `ENGLISH-STD-4-2024.db` (SQLite) |
