...
async def generate(concurrency: int, start_row: int, requested: set[str]) -> None:
    import edge_tts
...
def main() -> None:
    ...
    parser.add_argument("--ids", default="", help="Comma-separated base text IDs")
    ...
    asyncio.run(generate(args.concurrency, args.start_row, requested))
